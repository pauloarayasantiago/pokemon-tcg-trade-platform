...
All documentation for this project is located in the `docs/` directory. The main entry point for documentation is [docs/index.md](docs/index.md).

> **Note:** Several deprecated documentation files have been moved to the `archive/` directory. Always refer to the documentation in the `docs/` directory for the most current information.

### Documentation Validation

The project includes comprehensive documentation validation tools that run automatically on every push and pull request through GitHub Actions. The validation process checks:
...
- `check-doc-references`: Validates file references in documentation
- `validate-mermaid`: Checks Mermaid diagram syntax
- `validate-frontmatter`: Validates YAML frontmatter in documentation files
...
# Add frontmatter to a new documentation file
npm run add-frontmatter docs/new-file.md

# Add a Mermaid diagram template
npm run add-mermaid docs/new-file.md
```

#### Pre-commit Hooks

The project uses Husky to run documentation validation before each commit. This ensures that all documentation changes meet our quality standards before being committed.
...
Validation results are available as artifacts in the GitHub Actions workflow.
